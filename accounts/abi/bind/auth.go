...
// NewTransactor is a utility mechod to easily create a transaction signer from
...
// NewKeyedTransactor is a utility mechod to easily create a transaction signer
