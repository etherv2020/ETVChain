...
// Package accounts implements high level Etvchain account management.
package accounts
...
// Account represents an Etvchain account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address common.Address `json:"address"` // Etvchain account address derived from the key
...
type Wallet interface {
	...
	// particular wallet instance. The reason there is no passwordless open mechod
	...
	// Contains returns whetvchain an account is part of this particular wallet or not.
	...
	// chain state reader.
	SelfDerive(base DerivationPath, chain etvchaineum.ChainStateReader)
