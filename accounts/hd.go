...
// the `coin_type` 60' (or 0x8000003C) to Etvchain.
//
// The root path for Etvchain is m/44'/60'/0'/0 according to the specification
// from https://github.com/etvchaineum/EIPs/issues/84, albeit it's not set in stone
// yet whetvchain accounts should increment the last component or the children of
