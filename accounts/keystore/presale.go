...
func decryptPreSaleKey(fileContent []byte, password string) (key *Key, err error) {
	...
	/*
		See https://github.com/etvchaineum/pyechsaletool

		pyechsaletool generates the encryption key from password by
	...
	*/
	...
	echPriv := crypto.Keccak256(plainText)
	ecKey := crypto.ToECDSAUnsafe(echPriv)
