...
// Status implements accounts.Wallet, returning whetvchain the account held by the
...
func (w *keystoreWallet) SelfDerive(base accounts.DerivationPath, chain etvchaineum.ChainStateReader) {}
