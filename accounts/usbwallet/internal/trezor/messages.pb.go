...
const (
	...
	MessageType_MessageType_EtvchainGetAddress       MessageType = 56
	MessageType_MessageType_EtvchainAddress          MessageType = 57
	MessageType_MessageType_EtvchainSignTx           MessageType = 58
	MessageType_MessageType_EtvchainTxRequest        MessageType = 59
	MessageType_MessageType_EtvchainTxAck            MessageType = 60
	...
	MessageType_MessageType_EtvchainSignMessage      MessageType = 64
	MessageType_MessageType_EtvchainVerifyMessage    MessageType = 65
	MessageType_MessageType_EtvchainMessageSignature MessageType = 66
...
var MessageType_name = map[int32]string{
	...
	56:  "MessageType_EtvchainGetAddress",
	57:  "MessageType_EtvchainAddress",
	58:  "MessageType_EtvchainSignTx",
	59:  "MessageType_EtvchainTxRequest",
	60:  "MessageType_EtvchainTxAck",
	61:  "MessageType_GetECDHSessionKey",
	62:  "MessageType_ECDHSessionKey",
	63:  "MessageType_SetU2FCounter",
	64:  "MessageType_EtvchainSignMessage",
	65:  "MessageType_EtvchainVerifyMessage",
	66:  "MessageType_EtvchainMessageSignature",
...
var MessageType_value = map[string]int32{
	...
	"MessageType_EtvchainGetAddress":       56,
	"MessageType_EtvchainAddress":          57,
	"MessageType_EtvchainSignTx":           58,
	"MessageType_EtvchainTxRequest":        59,
	"MessageType_EtvchainTxAck":            60,
	"MessageType_GetECDHSessionKey":        61,
	"MessageType_ECDHSessionKey":           62,
	"MessageType_SetU2FCounter":            63,
	"MessageType_EtvchainSignMessage":      64,
	"MessageType_EtvchainVerifyMessage":    65,
	"MessageType_EtvchainMessageSignature": 66,
...
// *
// Request: Ask device for Etvchain address corresponding to address_n path
// @next PassphraseRequest
// @next EtvchainAddress
// @next Failure
type EtvchainGetAddress struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	ShowDisplay      *bool    `protobuf:"varint,2,opt,name=show_display,json=showDisplay" json:"show_display,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *EtvchainGetAddress) Reset()                    { *m = EtvchainGetAddress{} }
func (m *EtvchainGetAddress) String() string            { return proto.CompactTextString(m) }
func (*EtvchainGetAddress) ProtoMessage()               {}
func (*EtvchainGetAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{22} }

func (m *EtvchainGetAddress) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *EtvchainGetAddress) GetShowDisplay() bool {
	if m != nil && m.ShowDisplay != nil {
		return *m.ShowDisplay
	}
	return false
...
// *
// Response: Contains an Etvchain address derived from device private seed
// @prev EtvchainGetAddress
type EtvchainAddress struct {
	Address          []byte `protobuf:"bytes,1,req,name=address" json:"address,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *EtvchainAddress) Reset()                    { *m = EtvchainAddress{} }
func (m *EtvchainAddress) String() string            { return proto.CompactTextString(m) }
func (*EtvchainAddress) ProtoMessage()               {}
func (*EtvchainAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{24} }

func (m *EtvchainAddress) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
type RecoveryDevice struct {
	...
	// 7 reserved for unused recovery mechod
...
// This mechod doesn't support streaming, so there are hardware limits in number of inputs and outputs.
...
// @next PassphraseRequest
// @next PinMatrixRequest
// @next EtvchainTxRequest
// @next Failure
type EtvchainSignTx struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Nonce            []byte   `protobuf:"bytes,2,opt,name=nonce" json:"nonce,omitempty"`
...
func (m *EtvchainSignTx) Reset()                    { *m = EtvchainSignTx{} }
func (m *EtvchainSignTx) String() string            { return proto.CompactTextString(m) }
func (*EtvchainSignTx) ProtoMessage()               {}
func (*EtvchainSignTx) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{49} }

func (m *EtvchainSignTx) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *EtvchainSignTx) GetNonce() []byte {
	if m != nil {
		return m.Nonce
	}
	return nil
...
func (m *EtvchainSignTx) GetGasPrice() []byte {
	if m != nil {
		return m.GasPrice
	}
	return nil
...
func (m *EtvchainSignTx) GetGasLimit() []byte {
	if m != nil {
		return m.GasLimit
	}
	return nil
...
func (m *EtvchainSignTx) GetTo() []byte {
	if m != nil {
		return m.To
	}
	return nil
...
func (m *EtvchainSignTx) GetValue() []byte {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *EtvchainSignTx) GetDataInitialChunk() []byte {
	if m != nil {
...
func (m *EtvchainSignTx) GetDataLength() uint32 {
...
func (m *EtvchainSignTx) GetChainId() uint32 {
...
func (m *EtvchainTxRequest) Reset()                    { *m = EtvchainTxRequest{} }
func (m *EtvchainTxRequest) String() string            { return proto.CompactTextString(m) }
func (*EtvchainTxRequest) ProtoMessage()               {}
func (*EtvchainTxRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{50} }

func (m *EtvchainTxRequest) GetDataLength() uint32 {
	if m != nil && m.DataLength != nil {
		return *m.DataLength
	}
	return 0
...
func (m *EtvchainTxRequest) GetSignatureV() uint32 {
...
func (m *EtvchainTxRequest) GetSignatureR() []byte {
	if m != nil {
		return m.SignatureR
	}
	return nil
...
func (m *EtvchainTxRequest) GetSignatureS() []byte {
	if m != nil {
		return m.SignatureS
	}
	return nil
...
// @prev EtvchainTxRequest
// @next EtvchainTxRequest
type EtvchainTxAck struct {
	DataChunk        []byte `protobuf:"bytes,1,opt,name=data_chunk,json=dataChunk" json:"data_chunk,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *EtvchainTxAck) Reset()                    { *m = EtvchainTxAck{} }
func (m *EtvchainTxAck) String() string            { return proto.CompactTextString(m) }
func (*EtvchainTxAck) ProtoMessage()               {}
func (*EtvchainTxAck) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{51} }

func (m *EtvchainTxAck) GetDataChunk() []byte {
	if m != nil {
		return m.DataChunk
	}
	return nil
...
// *
// Request: Ask device to sign message
// @next EtvchainMessageSignature
// @next Failure
type EtvchainSignMessage struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Message          []byte   `protobuf:"bytes,2,req,name=message" json:"message,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *EtvchainSignMessage) Reset()                    { *m = EtvchainSignMessage{} }
func (m *EtvchainSignMessage) String() string            { return proto.CompactTextString(m) }
func (*EtvchainSignMessage) ProtoMessage()               {}
func (*EtvchainSignMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{52} }

func (m *EtvchainSignMessage) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *EtvchainSignMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// @next Success
// @next Failure
type EtvchainVerifyMessage struct {
...
func (m *EtvchainVerifyMessage) Reset()                    { *m = EtvchainVerifyMessage{} }
func (m *EtvchainVerifyMessage) String() string            { return proto.CompactTextString(m) }
func (*EtvchainVerifyMessage) ProtoMessage()               {}
func (*EtvchainVerifyMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{53} }

func (m *EtvchainVerifyMessage) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *EtvchainVerifyMessage) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *EtvchainVerifyMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// *
// Response: Signed message
// @prev EtvchainSignMessage
type EtvchainMessageSignature struct {
	Address          []byte `protobuf:"bytes,1,opt,name=address" json:"address,omitempty"`
	Signature        []byte `protobuf:"bytes,2,opt,name=signature" json:"signature,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *EtvchainMessageSignature) Reset()                    { *m = EtvchainMessageSignature{} }
func (m *EtvchainMessageSignature) String() string            { return proto.CompactTextString(m) }
func (*EtvchainMessageSignature) ProtoMessage()               {}
func (*EtvchainMessageSignature) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{54} }

func (m *EtvchainMessageSignature) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *EtvchainMessageSignature) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*EtvchainGetAddress)(nil), "EtvchainGetAddress")
	proto.RegisterType((*Address)(nil), "Address")
	proto.RegisterType((*EtvchainAddress)(nil), "EtvchainAddress")
	...
	proto.RegisterType((*EtvchainSignTx)(nil), "EtvchainSignTx")
	proto.RegisterType((*EtvchainTxRequest)(nil), "EtvchainTxRequest")
	proto.RegisterType((*EtvchainTxAck)(nil), "EtvchainTxAck")
	proto.RegisterType((*EtvchainSignMessage)(nil), "EtvchainSignMessage")
	proto.RegisterType((*EtvchainVerifyMessage)(nil), "EtvchainVerifyMessage")
	proto.RegisterType((*EtvchainMessageSignature)(nil), "EtvchainMessageSignature")
