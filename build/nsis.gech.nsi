...
# 1. install gech for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gech
# 5. create gech, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable ETVCHAIN_SOCKET
...
!define GROUPNAME "Etvchain"
!define APPNAME "Gech"
!define DESCRIPTION "Official Go implementation of the Etvchain protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gech is installed global
