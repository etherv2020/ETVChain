Name "gech ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/etvchaineum/go-etvchaineum/issues"
!define UPDATEURL "https://github.com/etvchaineum/go-etvchaineum/releases"
!define ABOUTURL "https://github.com/etvchaineum/go-etvchaineum#etvchaineum-go"
...
# Install gech binary
Section "Gech" GECH_IDX
  SetOutPath $INSTDIR
  file {{.Gech}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gech.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gech.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Gech incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gech outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gech UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gech incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\gech.exe" "" "" "Etvchain" 30303 "" "" ""
  SimpleFC::AdvAddRule "Gech outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\gech.exe" "" "" "Etvchain" "" 30303 "" ""
  SimpleFC::AdvAddRule "Gech UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\gech.exe" "" "" "Etvchain" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/etvchaineum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETVCHAIN_SOCKET" "R" "HKLM" "\\.\pipe\gech.ipc"
  ${EnvVarUpdate} $0 "ETVCHAIN_SOCKET" "A" "HKLM" "\\.\pipe\gech.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${GECH_IDX}
    SectionGetSize ${GECH_IDX} $0
