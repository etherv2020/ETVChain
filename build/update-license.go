...
Please review the resulting diff to check whetvchain the correct
...
var (
	...
	authorsFileHeader = "# This is the official list of go-etvchaineum authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-etvchaineum Authors
...
func (i info) Whole(startOfSentence bool) string {
	if i.gpl() {
		return "go-etvchaineum"
	}
	if startOfSentence {
		return "The go-etvchaineum library"
	}
	return "the go-etvchaineum library"
}
