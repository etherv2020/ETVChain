...
import (
	...
	"github.com/etvchaineum/go-etvchaineum/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the Etvchain contract ABI json to bind, - for STDIN")
	binFlag = flag.String("bin", "", "Path to the Etvchain contract bytecode (generate deploy mechod)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the Etvchain contract Solidity source to build and bind")
