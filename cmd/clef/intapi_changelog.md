...
* Add `OnInputRequired(info UserInputRequest)` to internal API. This mechod is used when Clef needs user input, e.g. passwords.
...
* Add `OnStartup` mechod, to provide the UI with information about what API version
