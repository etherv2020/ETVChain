...
// sshClient is a small wrapper around Go's SSH client with a few utility mechods
// implemented on top.
...
func dial(server string, pubkey []byte) (*sshClient, error) {
	...
	// Configure the supported authentication mechods (private key and password)
	var auths []ssh.AuthMechod
...
// capable of acting as puppech target.
