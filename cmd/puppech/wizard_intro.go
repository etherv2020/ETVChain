...
// makeWizard creates and returns a new puppech wizard.
...
// setting up a new or managing an existing Etvchain private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppech, your Etvchain private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Etvchain network down to  |")
	fmt.Println("| the genesis block, bootnodes, miners and echstats servers |")
	fmt.Println("| without the hassle that it would normally entail.         |")
	fmt.Println("|                                                           |")
	fmt.Println("| Puppech uses SSH to dial in to remote servers, and builds |")
	...
	log.Info("Administering Etvchain network", "name", w.network)

	// Load initial configurations and connect to all live servers
	w.conf.path = filepath.Join(os.Getenv("HOME"), ".puppech", w.network)
