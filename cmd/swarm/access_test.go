...
import (
	...
	"github.com/etvchaineum/go-etvchaineum/crypto/ecies"
	"github.com/etvchaineum/go-etvchaineum/log"
	"github.com/etvchaineum/go-etvchaineum/swarm/api"
	swarmapi "github.com/etvchaineum/go-etvchaineum/swarm/api/client"
...
func testPassword(t *testing.T) {
	...
	if authHeader == "" {
		t.Fatal("should be someching here")
	}
...
// the specs at https://github.com/etvchainsphere/swarm-docs/blob/eb857afda906c6e7bb90d37f3f334ccce5eef230/act.md
