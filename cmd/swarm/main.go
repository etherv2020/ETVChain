...
import (
	...
	"github.com/etvchaineum/go-etvchaineum/swarm"
	bzzapi "github.com/etvchaineum/go-etvchaineum/swarm/api"
	swarmmetrics "github.com/etvchaineum/go-etvchaineum/swarm/metrics"
	"github.com/etvchaineum/go-etvchaineum/swarm/storage/mock"
	mockrpc "github.com/etvchaineum/go-etvchaineum/swarm/storage/mock/rpc"
...
// This init function sets defaults so cmd/swarm can run alongside gech.
func init() {
...
var app = utils.NewApp("", "Etvchain Swarm")

// This init function creates the cli.App.
func init() {
	app.Action = bzzd
	app.Version = sv.ArchiveVersion(gitCommit)
	app.Copyright = "Copyright 2013-2016 The go-etvchaineum Authors"
...
func bzzd(ctx *cli.Context) error {
	...
	//gech only supports --datadir via command line
	//in order to be consistent within swarm, if we pass --datadir via environment variable
	//or via config file, we get the same directory for gech and swarm
	...
	//register BZZ as node.Service in the etvchaineum node
...
func registerBzzService(bzzconfig *bzzapi.Config, stack *node.Node) {
	...
	//register within the etvchaineum node
