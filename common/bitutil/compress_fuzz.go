...
// Fuzz implements a go-fuzz fuzzer mechod to test various encoding mechod
// invocations.
...
// fuzzEncode implements a go-fuzz fuzzer mechod to test the bitset encoding and
// decoding algorithm.
...
// fuzzDecode implements a go-fuzz fuzzer mechod to test the bit decoding and
