...
// Address represents the 20 byte address of an Etvchain account.
...
// IsHexAddress verifies whetvchain a string can represent a valid hex-encoded
// Etvchain address or not.
