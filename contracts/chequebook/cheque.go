...
// Package chequebook package wraps the 'chequebook' Etvchain smart contract.
//
// The functions in this package allow using chequebook for
// issuing, receiving, verifying cheques in etvchain; (auto)cashing cheques in etvchain
// as well as (auto)depositing etvchain to the chequebook contract.
package chequebook
...
import (
	...
	"github.com/etvchaineum/go-etvchaineum/contracts/chequebook/contract"
	...
	"github.com/etvchaineum/go-etvchaineum/swarm/services/swap/swap"
)
...
// * depositing etvchain to the chequebook
// * watching incoming etvchain
...
// Backend wraps all mechods required for chequebook operation.
...
// Cash is a convenience mechod to cash any cheque.
...
// Cash cashes the cheque by sending an Etvchain transaction.
