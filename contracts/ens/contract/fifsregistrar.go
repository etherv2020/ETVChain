...
// DeployFIFSRegistrar deploys a new Etvchain contract, binding an instance of FIFSRegistrar to it.
...
// FIFSRegistrar is an auto generated Go binding around an Etvchain contract.
...
// FIFSRegistrarCaller is an auto generated read-only Go binding around an Etvchain contract.
type FIFSRegistrarCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// FIFSRegistrarTransactor is an auto generated write-only Go binding around an Etvchain contract.
type FIFSRegistrarTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// FIFSRegistrarFilterer is an auto generated log filtering Go binding around an Etvchain contract events.
type FIFSRegistrarFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// FIFSRegistrarSession is an auto generated Go binding around an Etvchain contract,
...
// FIFSRegistrarCallerSession is an auto generated read-only Go binding around an Etvchain contract,
...
// FIFSRegistrarTransactorSession is an auto generated write-only Go binding around an Etvchain contract,
...
// FIFSRegistrarRaw is an auto generated low-level Go binding around an Etvchain contract.
type FIFSRegistrarRaw struct {
	Contract *FIFSRegistrar // Generic contract binding to access the raw mechods on
}

// FIFSRegistrarCallerRaw is an auto generated low-level read-only Go binding around an Etvchain contract.
type FIFSRegistrarCallerRaw struct {
	Contract *FIFSRegistrarCaller // Generic read-only contract binding to access the raw mechods on
}

// FIFSRegistrarTransactorRaw is an auto generated low-level write-only Go binding around an Etvchain contract.
type FIFSRegistrarTransactorRaw struct {
	Contract *FIFSRegistrarTransactor // Generic write-only contract binding to access the raw mechods on
}
...
// returns.
func (_FIFSRegistrar *FIFSRegistrarRaw) Call(opts *bind.CallOpts, result interface{}, mechod string, params ...interface{}) error {
	return _FIFSRegistrar.Contract.FIFSRegistrarCaller.contract.Call(opts, result, mechod, params...)
}
...
func (_FIFSRegistrar *FIFSRegistrarRaw) Transact(opts *bind.TransactOpts, mechod string, params ...interface{}) (*types.Transaction, error) {
	return _FIFSRegistrar.Contract.FIFSRegistrarTransactor.contract.Transact(opts, mechod, params...)
}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_FIFSRegistrar *FIFSRegistrarCallerRaw) Call(opts *bind.CallOpts, result interface{}, mechod string, params ...interface{}) error {
	return _FIFSRegistrar.Contract.contract.Call(opts, result, mechod, params...)
}
...
// Transact invokes the (paid) contract mechod with params as input values.
func (_FIFSRegistrar *FIFSRegistrarTransactorRaw) Transact(opts *bind.TransactOpts, mechod string, params ...interface{}) (*types.Transaction, error) {
	return _FIFSRegistrar.Contract.contract.Transact(opts, mechod, params...)
}

// Register is a paid mutator transaction binding the contract mechod 0xd22057a9.
//
