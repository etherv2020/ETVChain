...
type journalEntry interface {
	...
	// dirtied returns the Etvchain address modified by this journal entry.
...
// otherwise suggest it as clean. This mechod is an ugly hack to handle the RIPEMD
...
type (
	...
	suicideChange struct {
		account     *common.Address
		prev        bool // whetvchain account had already suicided
		prevbalance *big.Int
	}
