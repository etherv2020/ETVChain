...
func TestIntermediateLeaks(t *testing.T) {
	...
	transDb := echdb.NewMemDatabase()
	finalDb := echdb.NewMemDatabase()
...
// https://github.com/etvchaineum/go-etvchaineum/pull/15549.
func TestCopy(t *testing.T) {
	// Create a random state test to copy and modify "independently"
	orig, _ := New(common.Hash{}, NewDatabase(echdb.NewMemDatabase()))
...
// accessor mechods on the reverted state must match the return value of the equivalent
// mechods on the replayed state.
...
func (test *snapshotTest) run() bool {
	...
	var (
		state, _     = New(common.Hash{}, NewDatabase(echdb.NewMemDatabase()))
...
// checkEqual checks that mechods of state and checkstate return the same values.
...
// See https://github.com/etvchaineum/go-etvchaineum/pull/15225#issuecomment-380191512
func TestCopyOfCopy(t *testing.T) {
	sdb, _ := New(common.Hash{}, NewDatabase(echdb.NewMemDatabase()))
