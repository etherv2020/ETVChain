...
func makeTestState() (Database, common.Hash, []*testAccount) {
	...
	db := NewDatabase(echdb.NewMemDatabase())
...
// account array.
func checkStateAccounts(t *testing.T, db echdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db echdb.Database, root common.Hash) error {
...
func checkStateConsistency(db echdb.Database, root common.Hash) error {
...
func TestEmptyStateSync(t *testing.T) {
	...
	if req := NewStateSync(empty, echdb.NewMemDatabase()).Missing(1); len(req) != 0 {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(echdb.Database), srcRoot)
