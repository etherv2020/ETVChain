...
type TxPoolConfig struct {
	...
	NoLocals  bool             // Whetvchain local transaction handling should be disabled
...
// manner. This mechod is only ever used in the tester!
...
// validateTx checks whetvchain a transaction is valid according to the consensus
...
//
// Note, this mechod assumes the pool lock is held!
...
// and returns whetvchain it was inserted or an older was better.
//
// Note, this mechod assumes the pool lock is held!
...
func (pool *TxPool) addTxsLocked(txs []*types.Transaction, local bool) []error {
	...
	// Only reprocess the internal state if someching was actually added
	if len(dirty) > 0 {
...
// cannot be derived, this mechod returns false.
