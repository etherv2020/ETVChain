...
import (
	...
	"github.com/etvchaineum/go-etvchaineum/crypto/bn256"
	"github.com/etvchaineum/go-etvchaineum/params"
	"golang.org/x/crypto/ripemd160"
)

// PrecompiledContract is the basic interface for native Go contracts. The implementation
// requires a deterministic gas count based on the input size of the Run mechod of the
// contract.
...
// PrecompiledContractsHomestead contains the default set of pre-compiled Etvchain
...
// PrecompiledContractsByzantium contains the default set of pre-compiled Etvchain
...
//
// This mechod does not require any overflow checking as the input size gas costs
