...
type Context struct {
	// CanTransfer returns whetvchain the account contains
	// sufficient etvchain to transfer the value
	CanTransfer CanTransferFunc
	// Transfer transfers etvchain from one account to the other
...
// EVM is the Etvchain Virtual Machine base object and provides
...
type EVM struct {
	...
	// evm.
	vmConfig Config
	// global (to this context) etvchaineum virtual machine
...
func (evm *EVM) create(caller ContractRef, codeAndHash *codeAndHash, gas uint64, value *big.Int, address common.Address) ([]byte, common.Address, uint64, error) {
	...
	// check whetvchain the max code size has been exceeded
