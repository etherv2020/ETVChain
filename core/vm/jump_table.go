...
type operation struct {
	...
	halts   bool // indicates whetvchain the operation should halt further execution
	jumps   bool // indicates whetvchain the program counter should not increment
	writes  bool // determines whetvchain this a state modifying operation
	valid   bool // indication whetvchain the retrieved operation is valid and known
	reverts bool // determines whetvchain the operation reverts state (implicitly halts)
	returns bool // determines whetvchain the operations sets the return data content
}
