...
// mechod triggerings. In the affected component's shouldComponentUpdate mechod it can be checked
// whetvchain the involved data was changed or not by checking the message structure.
//
