...
func newTestLDB() (*echdb.LDBDatabase, func()) {
	dirname, err := ioutil.TempDir(os.TempDir(), "echdb_test_")
	if err != nil {
		panic("failed to create test file: " + err.Error())
	}
	db, err := echdb.NewLDBDatabase(dirname, 0, 0)
	if err != nil {
...
func TestMemoryDB_PutGet(t *testing.T) {
	testPutGet(echdb.NewMemDatabase(), t)
}

func testPutGet(db echdb.Database, t *testing.T) {
	t.Parallel()
...
func TestMemoryDB_ParallelPutGet(t *testing.T) {
	testParallelPutGet(echdb.NewMemDatabase(), t)
}

func testParallelPutGet(db echdb.Database, t *testing.T) {
	const n = 8
