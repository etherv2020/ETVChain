...
// The app's SubscribeResults mechod starts sending calculation results to the given
// channel. Subscriptions created through this mechod are tied to the lifetime of the App
