...
// to the ECH network. The implementations of the functions should be non-blocking.
//
...
// validateTx checks whetvchain a transaction is valid according to the consensus rules.
