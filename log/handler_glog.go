...
type GlogHandler struct {
	...
	override  uint32 // Flag whetvchain overrides are used, atomically accessible
	backtrace uint32 // Flag whetvchain backtrace location is set
...
func (h *GlogHandler) Log(r *Record) error {
	// If backtracing is requested, check whetvchain this is the callsite
