...
var (
	...
	echashChainConfig *params.ChainConfig
...
func init() {
	...
	echashChainConfig = params.TestChainConfig
...
func newTestWorker(t *testing.T, chainConfig *params.ChainConfig, engine consensus.Engine, blocks int) (*worker, *testWorkerBackend) {
	...
	w.setEtvchainbase(testBankAddress)
	return w, backend
}

func TestPendingStateAndBlockEthash(t *testing.T) {
	testPendingStateAndBlock(t, echashChainConfig, echash.NewFaker())
}
func TestPendingStateAndBlockClique(t *testing.T) {
	testPendingStateAndBlock(t, cliqueChainConfig, clique.New(cliqueChainConfig.Clique, echdb.NewMemDatabase()))
}
...
func TestEmptyWorkEthash(t *testing.T) {
	testEmptyWork(t, echashChainConfig, echash.NewFaker())
}
func TestEmptyWorkClique(t *testing.T) {
	testEmptyWork(t, cliqueChainConfig, clique.New(cliqueChainConfig.Clique, echdb.NewMemDatabase()))
}
...
func TestStreamUncleBlock(t *testing.T) {
	echash := echash.NewFaker()
	defer echash.Close()

	w, b := newTestWorker(t, echashChainConfig, echash, 1)
	defer w.close()
...
func TestRegenerateMiningBlockEthash(t *testing.T) {
	testRegenerateMiningBlock(t, echashChainConfig, echash.NewFaker())
}

func TestRegenerateMiningBlockClique(t *testing.T) {
	testRegenerateMiningBlock(t, cliqueChainConfig, clique.New(cliqueChainConfig.Clique, echdb.NewMemDatabase()))
}
...
func TestAdjustIntervalEthash(t *testing.T) {
	testAdjustInterval(t, echashChainConfig, echash.NewFaker())
}

func TestAdjustIntervalClique(t *testing.T) {
	testAdjustInterval(t, cliqueChainConfig, clique.New(cliqueChainConfig.Clique, echdb.NewMemDatabase()))
}
