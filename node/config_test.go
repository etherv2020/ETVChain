...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gech.ipc", false, filepath.Join(os.TempDir(), "gech.ipc")},
		{"data", "gech.ipc", false, "data/gech.ipc"},
		{"data", "./gech.ipc", false, "./gech.ipc"},
		{"data", "/gech.ipc", false, "/gech.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gech.ipc", true, `\\.\pipe\gech.ipc`},
		{"data", "gech.ipc", true, `\\.\pipe\gech.ipc`},
		{"data", `\\.\pipe\gech.ipc`, true, `\\.\pipe\gech.ipc`},
	}
