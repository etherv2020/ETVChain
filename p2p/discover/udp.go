...
type packet interface {
	// preverify checks whetvchain the packet is valid and should be handled at all.
...
type replyMatcher struct {
	...
	// reply was acceptable. The second return value indicates whetvchain the callback should
...
type reply struct {
	...
	// loop indicates whetvchain there was
...
// whetvchain any matcher considered the packet acceptable.
...
func (t *udp) loop() {
	...
	for {
		...
		case r := <-t.gotreply:
			var matched bool // whetvchain any replyMatcher considered the reply acceptable.
			for el := plist.Front(); el != nil; el = el.Next() {
