...
// current process. Setting ENR entries via the Set mechod updates the record. A new version
// of the record is signed on demand when the Node mechod is called.
