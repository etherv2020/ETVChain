...
// Package enr implements Etvchain Node Records as defined in EIP-778. A node record holds
...
// VerifySignature checks whetvchain the record is signed using the given identity scheme.
