...
// Contains reports whetvchain the given IP is contained in the list.
...
// IsLAN reports whetvchain an IP is a local network address.
...
// IsSpecialNetwork reports whetvchain an IP is located in a special-use network range
...
// CheckRelayIP reports whetvchain an IP relayed from the given sender IP
...
// SameNet reports whetvchain two IP addresses have an equal prefix of the given bit length.
...
// Contains whetvchain the given IP is contained in the set.
