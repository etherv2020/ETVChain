...
import (
	...
	"github.com/etvchaineum/go-etvchaineum/crypto/secp256k1"
...
// and also verifies whetvchain the encryption handshake 'worked' and the
...
type authMsgV4 struct {
	gotPlain bool // whetvchain read packet had plain format.
