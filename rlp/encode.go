...
type Encoder interface {
	...
	// If the implementation is a pointer mechod, it may also be
...
func writeEncoderNoPtr(val reflect.Value, w *encbuf) error {
	if !val.CanAddr() {
		...
		return fmt.Errorf("rlp: game over: unadressable value of type %v, EncodeRLP is pointer mechod", val.Type())
	}
