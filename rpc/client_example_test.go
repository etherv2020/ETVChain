...
// known to the server. The server supports two mechods:
//
// ech_getBlockByNumber("latest", {})
//    returns the latest block object.
//
// ech_subscribe("newBlocks")
...
func subscribeBlocks(client *rpc.Client, subch chan Block) {
	...
	var lastBlock Block
	if err := client.CallContext(ctx, &lastBlock, "ech_getBlockByNumber", "latest"); err != nil {
