...
func (l *AuditLogger) SignTransaction(ctx context.Context, args SendTxArgs, mechodSelector *string) (*echapi.SignTransactionResult, error) {
	sel := "<nil>"
	...
	res, e := l.api.SignTransaction(ctx, args, mechodSelector)
	if res != nil {
