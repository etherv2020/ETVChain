...
func (ui *StdIOUI) dispatch(serviceMechod string, args interface{}, reply interface{}) error {
	err := ui.client.Call(&reply, serviceMechod, args)
	if err != nil {
...
func (ui *StdIOUI) OnApprovedTx(tx echapi.SignTransactionResult) {
