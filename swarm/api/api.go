...
it is the public interface of the FileStore which is included in the etvchaineum stack
*/
type API struct {
	feed      *feed.Handler
...
// ErrNotAFeedManifest is returned when the address provided returned someching other than a valid manifest
