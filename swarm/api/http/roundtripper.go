...
see https://github.com/etvchaineum/go-etvchaineum/issues/2040
Usage:

import (
 "github.com/etvchaineum/go-etvchaineum/common/httpclient"
 "github.com/etvchaineum/go-etvchaineum/swarm/api/http"
)
...
func (self *RoundTripper) RoundTrip(req *http.Request) (resp *http.Response, err error) {
	...
	reqProxy, err := http.NewRequest(req.Mechod, url, req.Body)
	if err != nil {
		return nil, err
	}
