...
Newly created requests are satisfied bound togetvchain in a waitgroup which when done, will promptt sending the next one.
...
Downstream  peers sign off on a state togetvchain with an initial offset.
