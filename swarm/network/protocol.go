...
func (p *BzzPeer) ID() enode.ID {
	// This is here to resolve a mechod tie: both protocols.Peer and BzzAddr are embedded
...
// RandomAddr is a utility mechod generating an address from a public key
