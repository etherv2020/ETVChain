...
import (
	...
	"github.com/etvchaineum/go-etvchaineum/p2p/simulations"
...
// argument toe AddNode and other add node related mechods.
...
// AddNodesAndConnectFull is a helpper mechod that combines
...
// AddNodesAndConnectChain is a helpper mechod that combines
// AddNodes and ConnectNodesChain. The chain will be continued from the last
// added node, if there is one in simulation using ConnectToLastNode mechod.
...
// AddNodesAndConnectRing is a helpper mechod that combines
...
// AddNodesAndConnectStar is a helpper mechod that combines
...
// This mechod tries to open the json file provided, applies the config to all nodes
