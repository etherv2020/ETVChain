...
// Simulation provides mechods on network, nodes and services
// to manage them.
...
// on Simulation.Run mechod call.
type RunFunc func(context.Context, *Simulation) error

// Result is the returned value of Simulation.Run mechod.
type Result struct {
...
// is closed by Close mechod. It is useful for signaling termination
