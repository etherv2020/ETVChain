...
// TestRun tests if Run mechod calls RunFunc and if it handles context properly.
...
// TestClose tests are Close mechod triggers all close functions and are all nodes not up anymore.
...
// TestDone checks if Close mechod triggers the closing of done channel.
