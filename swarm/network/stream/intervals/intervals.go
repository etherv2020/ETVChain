...
// mechods to add new intervals and retrieve missing intervals that
// need to be added.
...
// No range bellow start bound will be added by Add mechod or
// returned by Next mechod. This limit may be used for
