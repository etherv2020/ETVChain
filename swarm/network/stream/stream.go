...
import (
	...
	"github.com/etvchaineum/go-etvchaineum/swarm/network/stream/intervals"
...
// setNextBatch adjusts passed interval based on session index and whetvchain
...
// the price for a message via the Price mechod
