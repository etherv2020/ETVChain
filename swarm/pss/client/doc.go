...
//
// IO is performed using the ordinary p2p.MsgReadWriter interface, which transparently communicates with a pss node via RPC using websockets as transport layer, using mechods in the PssAPI class in the swarm/pss package
//
//
...
//  	"fmt"
//  	"os"
//  	pss "github.com/etvchaineum/go-etvchaineum/swarm/pss/client"
...
//
//      // use the protocol for someching
//
//      psc.Stop()
//  }
//
