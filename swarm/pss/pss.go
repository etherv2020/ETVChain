...
type Pss struct {
	...
	*KeyStore
	...
	fwdCache        map[pssDigest]pssCacheEntry // checksum of unique fields from pssmsg mapped to expiry, cache to determine whetvchain to drop msg
...
// add API mechods to the pss API
