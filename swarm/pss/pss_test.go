...
// matching of address hints; whetvchain a message could be or is for the node
...
func TestAddressMatchProx(t *testing.T) {
	...
	// first the unit test on the mechod that calculates possible receipient using prox
