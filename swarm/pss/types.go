...
// Implementations of this type are passed to Pss.Register togetvchain with a topic,
...
// WithRaw is a chainable mechod that allows raw messages to be handled.
func (h *handler) WithRaw() *handler {
	h.caps.raw = true
	return h
}

// WithProxBin is a chainable mechod that allows sending messages with full addresses to neighbourhoods using the kademlia depth as reference
