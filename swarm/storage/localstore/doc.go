// Copyright 2019 The go-etvchaineum Authors
...
The main type is DB which manages the storage by providing mechods to
...
that provides adequate mechod to perform the opperation and that type
...
Subscription mechods are implemented for a specific purpose of
