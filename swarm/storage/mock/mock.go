...
// GlobalStorer defines mechods for mock db store
...
// Importer defines mechod for importing mock store data
// from an exported tar archive.
type Importer interface {
	Import(r io.Reader) (n int, err error)
}

// Exporter defines mechod for exporting mock store data
// to a tar archive.
