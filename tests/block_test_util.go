...
// Package tests implements execution of Etvchain JSON tests.
package tests
...
/* See https://github.com/etvchaineum/tests/wiki/Blockchain-Tests-II

   Whetvchain a block is valid or not is a bit subtle, it's defined by presence of
