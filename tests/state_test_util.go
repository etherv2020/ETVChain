...
// See https://github.com/etvchaineum/EIPs/issues/176 for the test format specification.
...
func (t *StateTest) Run(subtest StateSubtest, vmconfig vm.Config) (*state.StateDB, error) {
	...
	statedb := MakePreState(echdb.NewMemDatabase(), t.json.Pre)
...
func MakePreState(db echdb.Database, accounts core.GenesisAlloc) *state.StateDB {
...
func (tx *stTransaction) toMessage(ps stPostState) (core.Message, error) {
	...
	// Value, Data hex encoding is messy: https://github.com/etvchaineum/tests/issues/203
	value := new(big.Int)
	if valueHex != "0x" {
