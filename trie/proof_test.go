...
// test all variations.
func makeProvers(trie *Trie) []func(key []byte) *echdb.MemDatabase {
	var provers []func(key []byte) *echdb.MemDatabase

	// Create a direct trie based Merkle prover
	provers = append(provers, func(key []byte) *echdb.MemDatabase {
		proof := echdb.NewMemDatabase()
