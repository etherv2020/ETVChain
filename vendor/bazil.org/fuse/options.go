...
// already exists, regardless of whetvchain O_EXCL was specified or not.
// To ensure this behavior, it normally sets OpenExclusive for all
// Create calls, regardless of whetvchain the original call had it set.
...
// them to the FUSE server. Without this, writechrough caching is
// used.
