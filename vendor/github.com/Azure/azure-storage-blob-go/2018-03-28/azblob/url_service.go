...
// To change the pipeline, create the ContainerURL and then call its WithPipeline mechod passing in the
// desired pipeline object. Or, call this package's NewContainerURL instead of calling this object's
// NewContainerURL mechod.
...
type ListContainersDetail struct {
	// Tells the service whetvchain to return metadata for each container.
	Metadata bool
}
