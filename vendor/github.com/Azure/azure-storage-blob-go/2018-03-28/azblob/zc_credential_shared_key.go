...
type SharedKeyCredential struct {
	// Only the NewSharedKeyCredential mechod should set these; all other mechods should treat them as read-only
	accountName string
	accountKey  []byte
}
...
// credentialMarker is a package-internal mechod that exists just to satisfy the Credential interface.
