...
// blockBlobClient is the client for the BlockBlob mechods of the Azblob service.
...
// then committing the new and existing blocks togetvchain. You can do this by specifying whetvchain to commit a block from
...
// blob
//
// listType is specifies whetvchain to return the list of committed blocks, the list of uncommitted blocks, or both lists
// togetvchain. snapshot is the snapshot parameter is an opaque DateTime value that, when present, specifies the blob
