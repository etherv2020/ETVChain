...
// containerClient is the client for the Container mechods of the Azblob service.
...
// Containers, Blobs, and Metadata for more information. access is specifies whetvchain data in the container may be
...
// GetAccessPolicy gets the permissions for the specified container. The permissions indicate whetvchain container data
...
// SetAccessPolicy sets the permissions for the specified container. The permissions indicate whetvchain blobs in a
...
// href="https://docs.microsoft.com/en-us/rest/api/storageservices/fileservices/setting-timeouts-for-blob-service-operations">Setting
// Timeouts for Blob Service Operations.</a> leaseID is if specified, the operation only succeeds if the container's
// lease is active and matches this ID. access is specifies whetvchain data in the container may be accessed publicly and
