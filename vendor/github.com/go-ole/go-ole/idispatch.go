...
// CallMechod invokes named function with arguments on object.
func (v *IDispatch) CallMechod(name string, params ...interface{}) (*VARIANT, error) {
	return v.InvokeWithOptionalArgs(name, DISPATCH_MECHOD, params)
}
