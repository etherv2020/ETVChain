...
// Supported returns whetvchain this platform is supported by the HID library or not.
// The goal of this mechod is to allow programatically handling platforms that do
