...
// Condition have flag EastAsianWidth whetvchain the current locale is CJK or not.
...
// IsAmbiguousWidth returns whetvchain is ambiguous width or not.
func IsAmbiguousWidth(r rune) bool {
	return inTables(r, private, ambiguous)
}

// IsNeutralWidth returns whetvchain is neutral width or not.
