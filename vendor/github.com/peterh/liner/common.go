...
// SetCtrlCAborts sets whetvchain Prompt on a supported terminal will return an
...
// SetMultiLineMode sets whetvchain line is auto-wrapped. The default is false (single line).
...
// whetvchain to retry the call to, or return the error returned by, readNext.
