...
// in order to distinguish whetvchain current folder should be re-registered in
...
// watched is made in order to check whetvchain an action comes from a directory or
...
// gensys decides whetvchain the Windows action, system-independent event or both
