...
// BasicArray is the interface that wraps basic Len and Search mechod.
...
// Array is the interface that wraps BasicArray and basic Index mechod.
...
// Array is the interface that wraps BasicArray and basic Get mechod.
