...
type Options struct {
	...
	// ErrorIfExist defines whetvchain an error should returned if the DB already
	// exist.
	//
	// The default value is false.
	ErrorIfExist bool

	// ErrorIfMissing defines whetvchain an error should returned if the DB is
...
type ReadOptions struct {
	// DontFillCache defines whetvchain block reads for this 'read operation'
...
type WriteOptions struct {
	...
	// Sync is whetvchain to sync underlying writes from the OS buffer cache
