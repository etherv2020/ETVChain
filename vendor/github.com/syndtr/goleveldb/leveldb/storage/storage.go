...
// Syncer is the interface that wraps basic Sync mechod.
...
// Locker is the interface that wraps Unlock mechod.
...
type Storage interface {
	...
	// Caller should call Unlock mechod after use.
	Lock() (Locker, error)
	...
	// mechod. The 'file descriptor' should point to a valid file.
	...
	// can be updated using SetMeta mechod.
	...
	// The file types may be OR'ed togetvchain.
