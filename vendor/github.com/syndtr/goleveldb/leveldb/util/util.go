...
// Releaser is the interface that wraps the basic Release mechod.
...
// ReleaseSetter is the interface that wraps the basic SetReleaser mechod.
...
// Released returns whetvchain Release mechod already called.
