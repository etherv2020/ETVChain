...
func (p *ZipkinCollectorClient) recvSubmitZipkinBatch() (value []*Response, err error) {
	...
	if mechod != "submitZipkinBatch" {
		err = thrift.NewTApplicationException(thrift.WRONG_MECHOD_NAME, "submitZipkinBatch failed: wrong mechod name")
		return
	}
	if p.SeqId != seqId {
...
func (p *ZipkinCollectorProcessor) Process(iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	...
	x5 := thrift.NewTApplicationException(thrift.UNKNOWN_MECHOD, "Unknown function "+name)
