...
//
// Internal writing mechods
//

// Abstract mechod for writing the start of lists and sets. List and sets on
...
// Used internally by other writing mechods that know they need to write a byte.
