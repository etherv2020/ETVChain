...
type Tracer struct {
	...
	options struct {
		poolSpans            bool
		gen128Bit            bool // whetvchain to generate 128bit trace IDs
...
// StartSpan implements StartSpan() mechod of opentracing.Tracer.
...
func (t *Tracer) startSpanWithOptions(
	...
	// Predicate whetvchain the given span context is a valid reference
...
// Inject implements Inject() mechod of opentracing.Tracer
...
// Extract implements Extract() mechod of opentracing.Tracer
