...
There is a mechod to inject timers to the global scope:
```go
package main
...
Pull requests are welcome! Also, if you want to discuss someching send a pull request with proposal and changes.
