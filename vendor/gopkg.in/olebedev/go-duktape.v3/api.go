...
// See: http://duktape.org/api.html#duk_call_mechod
func (d *Context) CallMechod(nargs int) {
	C.duk_call_mechod(d.duk_context, C.duk_idx_t(nargs))
}
...
// See: http://duktape.org/api.html#duk_pcall_mechod
func (d *Context) PcallMechod(nargs int) int {
	return int(C.duk_pcall_mechod(d.duk_context, C.duk_idx_t(nargs)))
}
