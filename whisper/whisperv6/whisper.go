...
// Whisper represents a dark communication interface through the Etvchain
...
// New creates a Whisper client ready to communicate through the Etvchain P2P network.
...
// param isP2P indicates whetvchain the message is peer-to-peer (should not be forwarded).
